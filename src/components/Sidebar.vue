<script setup lang="ts">
    ...
    const { isMobile, isSidebarOpen, sidebarClasses, closeSidebar } = useSidebar()
</script>
    ...
    <nav class="p-4 space-y-2">
      ...
      <router-link to="/commerce/guidline-book/introduction" v-slot="{ isExactActive }">
        <div
          ...
          :class="isExactActive
            ? 'bg-[linear-gradient(135deg,#4A8D7C,#19468E)] text-white shadow'
      ...
      <router-link to="/commerce/guidline-book/voucher" v-slot="{ isActive }">
        <div
          class="block rounded-lg px-4 py-3 transition"
          :class="isActive
            ? 'bg-[linear-gradient(135deg,#4A8D7C,#19468E)] text-white shadow'
      ...
      <router-link to="/commerce/guidline-book/setting" v-slot="{ isActive }">
        <div
          class="block rounded-lg px-4 py-3 transition"
          :class="isActive
            ? 'bg-[linear-gradient(135deg,#4A8D7C,#19468E)] text-white shadow'
      ...
      <router-link to="/commerce/guidline-book/faq" v-slot="{ isActive }">
        <div
          class="block rounded-lg px-4 py-3 transition"
          :class="isActive
            ? 'bg-[linear-gradient(135deg,#4A8D7C,#19468E)] text-white shadow'
